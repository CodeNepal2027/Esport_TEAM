...
const Home_Sponser = () => {
    const { color_code_1, color_code_2, team_name, org_whatsapp } = getOrgConfig();
    ...
    // Build WhatsApp partner link with a prefilled message
    const whatsappDigits = org_whatsapp
        ? String(org_whatsapp).replace(/[^0-9]/g, '')
        : '';
    const partnerMessage = encodeURIComponent(
        `Hi ${team_name || 'Team'},\n\nI'd like to discuss a sponsorship/partnership opportunity.`
    );
    const whatsappPartnerLink = whatsappDigits
        ? `https://wa.me/${whatsappDigits}?text=${partnerMessage}`
        : null;
            ...
            <div className="container">
                <div className="section-header">
                    ...
                    <h2 className="section-title">
                        <span style={{ color: color_code_1 }}>Trusted</span> Partners
                    </h2>
                ...
                <div className="sponsor-cta" style={{
                    ...
                    <div className="cta-content">
                        ...
                        {whatsappPartnerLink ? (
                            ...
                            >
                                <i className="bi bi-whatsapp"></i> Partner With Us
                            </a>
                        ) : (
                            <button
                                className="cta-btn"
