            ...
            <section id="home-hero-section" className="home-hero-section">
                <div className="hero-slider">
                    <div className="hero-slide active">
                        <div className="hero-image-wrapper">
                            <div className="hero-skeleton hero-skeleton-image"></div>
                            <div className="hero-overlay"></div>
                        </div>

                        <div className="hero-content">
                            <div className="hero-skeleton hero-skeleton-badge"></div>
                            <div className="hero-skeleton hero-skeleton-title"></div>
                            <div className="hero-skeleton hero-skeleton-title hero-skeleton-title-short"></div>
                            <div className="hero-skeleton hero-skeleton-subtitle"></div>
                            <div className="hero-skeleton hero-skeleton-subtitle hero-skeleton-subtitle-short"></div>
                            <div className="hero-actions">
                                <div className="hero-skeleton hero-skeleton-btn"></div>
                                <div className="hero-skeleton hero-skeleton-btn"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="hero-dots">
                    <div className="hero-skeleton hero-skeleton-dot"></div>
                    <div className="hero-skeleton hero-skeleton-dot"></div>
                    <div className="hero-skeleton hero-skeleton-dot"></div>
                </div>

                {/* Team Info Overlay Skeleton */}
                <div className="hero-team-info">
                    <div className="hero-skeleton hero-skeleton-team-tag"></div>
                    <div className="hero-skeleton hero-skeleton-team-name"></div>
                </div>
            </section>
        );
    }
