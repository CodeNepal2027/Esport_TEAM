...
const Home_Gallery = () => {
    ...
    // 2 rows by default → leaves items wrapped for View More
    const getInitialCount = () => getColumnsPerRow() * 2;
    ...
    // Latest photo first (newest → oldest), like a stack
    const galleryImages = gallery ? [...gallery].reverse() : [];
    ...
    const loadMore = () => {
        const additionalRows = columnsPerRow * 2;
    ...
    return (
        <section id="home-gallery-section" className="home-gallery-section">
            <div className="container">
                ...
                {/* ============================================
                    VIEW MORE / VIEW LESS
                    Only renders when there's something to show/hide
                   ============================================ */}
                {(hasMore || hasLess) && (
                    <div className="gallery-actions">
                        {hasMore && (
                            <button
                                className="gallery-view-btn gallery-view-more"
                                onClick={loadMore}
                        ...
                        {hasLess && (
                            <button
                                className="gallery-view-btn gallery-view-less"
                                onClick={loadLess}
                                style={{ '--btn-accent': color_code_1 }}
                            >
