...
const DEMO_CLIENT = {
    ...
    events: [
        ...
        { id: 2, title: 'Regional Qualifier',      description: 'Battle for a spot at the world stage.',                        image: 'https://images.unsplash.com/photo-1560253023-3ec5d502959f?w=800&h=500&fit=crop', date: 'Oct 05-08, 2026', location: 'Berlin, Germany',      prizePool: '$150,000',   status: 'upcoming',  category: 'qualifier' },
        { id: 3, title: 'Fan Meet & Greet',        description: 'Meet the squad, get autographs, and grab exclusive merch.',    image: 'https://images.unsplash.com/photo-1493711662062-fa541adb3fc8?w=800&h=500&fit=crop', date: 'Nov 02, 2026',    location: 'Kathmandu, Nepal',     prizePool: 'Free Entry', status: 'upcoming',  category: 'fan_meet' },
        { id: 4, title: 'Community Cup',           description: 'Open tournament for aspiring players from our community.',     image: 'https://images.unsplash.com/photo-1550745165-9bc0b252726f?w=800&h=500&fit=crop', date: 'Aug 22-24, 2026', location: 'Online',               prizePool: '$5,000',     status: 'ongoing',   category: 'community' },
        { id: 5, title: 'Charity Showmatch',       description: 'A friendly showmatch with all proceeds going to charity.',     image: 'https://images.unsplash.com/photo-1511512578047-dfb367046420?w=800&h=500&fit=crop', date: 'Jul 12, 2026',    location: 'London, UK',           prizePool: '$25,000',    status: 'ongoing',   category: 'showmatch' },
        { id: 6, title: 'Esports Expo 2026',       description: 'Industry expo — meet teams, sponsors, and creators.',          image: 'https://images.unsplash.com/photo-1493711662062-fa541adb3fc8?w=800&h=500&fit=crop', date: 'Jun 20-22, 2026', location: 'Los Angeles, USA',     prizePool: 'N/A',        status: 'ongoing',   category: 'expo' },
        { id: 7, title: 'Spring Invitational',     description: 'Invite-only tournament featuring the top regional teams.',     image: 'https://images.unsplash.com/photo-1550745165-9bc0b252726f?w=800&h=500&fit=crop', date: 'Apr 10-12, 2026', location: 'Dubai, UAE',           prizePool: '$500,000',   status: 'completed', category: 'tournament' },
        { id: 8, title: 'Winter Qualifier',        description: 'First qualifier of the season — a proving ground.',            image: 'https://images.unsplash.com/photo-1511882150382-421056c89033?w=800&h=500&fit=crop', date: 'Jan 15-17, 2026', location: 'Helsinki, Finland',    prizePool: '$100,000',   status: 'completed', category: 'qualifier' },
        { id: 9, title: 'Fan Appreciation Night', description: 'A night dedicated to the fans who make it all possible.',      image: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?w=800&h=500&fit=crop', date: 'Feb 28, 2026',    location: 'São Paulo, Brazil',    prizePool: 'Free Entry', status: 'completed', category: 'fan_meet' },
        { id: 10, title: 'Summer Showdown',        description: 'Mid-season showmatch against long-time rivals.',               image: 'https://images.unsplash.com/photo-1560253023-3ec5d502959f?w=800&h=500&fit=crop', date: 'Mar 22, 2026',    location: 'Tokyo, Japan',         prizePool: '$75,000',    status: 'completed', category: 'showmatch' },
    ],
